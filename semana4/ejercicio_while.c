/*Este programa sirve para convertir temperaturas y coordenadas.
No se sale del programa hasta que tu se lo indiques.
Creado el 29/08/2018 por Marco Gutiérrez.*/
#include <stdio.h>
#include <math.h>
...
int main()
{
	...
	printf("teclea 3 para salir del programa\n");
	scanf("%i", &opcion);
